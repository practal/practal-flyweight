import { declare, axiom, endTheory, beginTheory, importTheory, define, assume, note, subst, S, addAnte, bindAnte, freeSucc, freeAnte, bindSucc, setTeXMode, print } from "./workbench.js";
